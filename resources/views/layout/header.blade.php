                            ...
                            <li>
                                ...
                                <div class="setting ht-setting">
                                    <ul class="ht-setting-list">
                                        ...
                                        <li><a href="{{url('/logout')}}">Logout</a></li> <!-- Back for it later -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="hb-menu">
                        <nav>
                            <ul>
                                <li class="dropdown-holder"><a href="{{url("index")}}">Home</a>
                                </li>
                                    ...
                                    <ul class="megamenu hb-megamenu">
                                        <li>
                                            <ul>
                                                ...
                                                <li><a href="{{url('/product/ram')}}">RAM</a></li>
                                                <li><a href="{{url('/product/keyboard')}}">Keyboards</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="megamenu-static-holder"><a href="{{url("index")}}">Pages</a>
                                    <ul class="megamenu hb-megamenu">
                                        <li>
                                            <ul>
                                                <li><a href="{{url('login-register')}}">My Account & Register</a></li>
                                                <li><a href="{{url('checkout')}}">Checkout</a></li>
                                                <li><a href="{{url('shopping-cart')}}">Shopping Cart</a></li>
                                                <li><a href="{{url('souq/faq')}}">FAQ</a></li>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <li><a href="{{url('yourorders')}}">Your Orders</a>
                            <li>
