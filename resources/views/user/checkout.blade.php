                                ...
                                <div class="your-order-table table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="cart_item">
                                              <td class="cart-product-name"> {{$value->product_name}} <strong class="product-quantity"> x{{session()->get("quantity")}} </strong></td>
                                              <td class="cart-product-total"><span class="amount">{{$value->product_price}}</span></td>  
                                            </tr>
                                            @endforeach
                                        </tbody>
                                        <tfoot>
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount">{{$value->product_price * session()->get("quantity")}}</span></td>
                                            </tr>
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount">{{$value->product_price * session()->get("quantity")}}</span></strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
