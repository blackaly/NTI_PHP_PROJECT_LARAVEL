                            ...
                            <form method="post" action="{{url("/doRegister")}}" >
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        @csrf
                                        {{session()->get("Message")}}
                                        <input type="hidden" name="form_1" value="1">
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-20">
                                            <label>Name</label>
                                            <input name="user_name" class="mb-0" type="text" placeholder="First Name">
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>Email Address*</label>
                                            <input name="user_email" class="mb-0" type="email" placeholder="Email Address">
                                        ...
                                        <div class="col-md-6 mb-20">
                                            <label>Password</label>
                                            <input name="user_password" class="mb-0" type="password" placeholder="Password">
                                        </div>
