            ...
            <div class="jsgrid-grid-header jsgrid-header-scrollbar">
              <table class="jsgrid-table">
                <tr class="jsgrid-header-row">
                  ...
                  <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">Supplier Name</th>
                  <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">Product Name</th>
                  <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">Product Price</th>
                  <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">Product Condition</th>
                  <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">Product Image</th>
              ...
              <table class="jsgrid-table">
                <tbody>
                  ...
                  <tr class="jsgrid-row">
                    ...
                    <td class="jsgrid-cell" style="width: 150px;">{{$value->supplier_name}}</td> 
                    <td class="jsgrid-cell" style="width: 150px;">{{$value->product_name}}</td> 
                    <td class="jsgrid-cell" style="width: 150px;">{{$value->product_price}}</td>
                    <td class="jsgrid-cell" style="width: 150px;">{{$value->product_condition}}</td>
                    <td class="jsgrid-cell" style="width: 150px;"><img src="{{url('product_images/' . $value->product_image)}}" alt=""></td>                    
                    ...
                    <td class="jsgrid-cell" style="width: 150px;">           
                        <a href='{{ url('admin/product/' . $value->id . '/edit') }}' class='btn btn-primary m-r-1em'>Edit</a>       
            ...
            <div class="modal-dialog" role="document">
              ...
              <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-footer">
                        <form action="{{ url('/admin/product/'.$value->id) }}" method="post">
