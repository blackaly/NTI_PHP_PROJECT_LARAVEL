            ...
            <div class="jsgrid-grid-header jsgrid-header-scrollbar">
              <table class="jsgrid-table">
                <tr class="jsgrid-header-row">
                  ...
                  <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 150px;">Email</th>
              ...
              <table class="jsgrid-table">
                <tbody>
                  ...
                  <tr class="jsgrid-row">
                    ...
                    <td class="jsgrid-cell" style="width: 150px;">{{$value->user_name}}</td> 
                    <td class="jsgrid-cell" style="width: 150px;">{{$value->email}}</td> 
                    ...
                    <td class="jsgrid-cell" style="width: 150px;">           
                        <a href='{{ url('admin/admin/' . $value->id . '/edit') }}' class='btn btn-primary m-r-1em'>Edit</a>       
