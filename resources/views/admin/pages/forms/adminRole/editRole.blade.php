        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('admin/role/' . $data[0]->id)}}"  method="post">
                @csrf
                @method("put");
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input value="{{$data[0]->type}}" name="type" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title">
                  </div>
                </div>
                <!-- /.card-body -->
